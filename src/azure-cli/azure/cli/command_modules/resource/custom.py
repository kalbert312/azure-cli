...
def create_deployment_stack_at_subscription(
    ...
    deny_settings_excluded_actions=None, deny_settings_apply_to_child_scopes=False, tags=None, yes=False, no_wait=False
):
...
def validate_deployment_stack_at_resource_group(
    ...
    deployment_stack_model = _prepare_validate_stack_at_scope(
        ...
        action_on_unmanage=action_on_unmanage, template_file=template_file, template_spec=template_spec, template_uri=template_uri,
